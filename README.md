...
GoHighLevel's workflow vocabulary ships inside the skill: **293 step and trigger
types** (145 native, the rest marketplace apps), each with its fields, allowed
...
at every plugin release — currently **0.56.1**. Please open issues and pull requests
